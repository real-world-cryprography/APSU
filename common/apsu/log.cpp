...
namespace apsu {
    ...
    void Log::DoLog(string msg, Level msg_level)
    {
        ...
        Logger::getInstance("APSU").log(ll, msg);
    }
    ...
    void Log::SetLogLevel(Log::Level level)
    {
        ...
        log_level_ = level;
        Logger::getInstance("APSU").setLogLevel(ll);
    }
