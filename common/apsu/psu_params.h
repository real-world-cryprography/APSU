    ...
    */
    ...
    public:
        ...
        */
        ...
        PSUParams(const PSUParams &copy) = default;

        PSUParams &operator=(const PSUParams &copy) = default;
        ...
        */
        ...
        /**
        Writes the PSUParams to a stream.
        */
        std::size_t save(std::ostream &out) const;

        /**
        Reads the PSUParams from a stream.
        */
        static std::pair<PSUParams, std::size_t> Load(std::istream &in);

        /**
        Reads the PSUParams from a JSON string
        */
        static PSUParams Load(const std::string &in);
