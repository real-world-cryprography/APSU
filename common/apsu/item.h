...
namespace std {
    ...
    */
    template <>
    struct hash<apsu::Item> {
        std::size_t operator()(const apsu::Item &item) const
        {
    ...
    template <>
    struct hash<apsu::HashedItem> {
        std::size_t operator()(const apsu::HashedItem &item) const
        {
            return hash<apsu::Item>()(item);
        }
    };
} // namespace std
