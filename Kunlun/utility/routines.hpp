...
inline std::string ToHexString(std::string byte_str)
{
    std::string hex_str;
    std::stringstream ss;
...
// 0 <= r_i < MAX
inline std::vector<int64_t> GenRandomNaturalIntegerVectorLessThan(size_t LEN, int64_t MAX)
{
...
// -MAX < r_i < MAX 
inline std::vector<int64_t> GenRandomIntegerVectorAbsoluteLessThan(size_t LEN, int64_t MAX)
{
