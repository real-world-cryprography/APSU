    ...
    namespace receiver {
        namespace util {
            ...
            public:
                ...
                HashFunc(apsu::util::felt_t seed)
                {
                    if (blake2xb(
                            random_array_.data(),
                            random_array_size_ * sizeof(apsu::util::felt_t),
                            &seed,
                            sizeof(seed),
                            nullptr,
                            0) != 0) {
                ...
                inline apsu::util::felt_t operator()(apsu::util::felt_t item) const noexcept
                {
            ...
            private:
                ...
                static constexpr std::size_t block_count_ = sizeof(apsu::util::felt_t);
                ...
                std::array<apsu::util::felt_t, random_array_size_> random_array_;
            };
        } // namespace util
    }     // namespace receiver
} // namespace apsu
