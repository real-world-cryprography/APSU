        ...
        namespace util {
            ...
            */
            ...
            public:
                ...
                */
                bool contains(const apsu::util::felt_t &item) const;

                /**
                Add an item to the Cuckoo Filter. Will fail if there is no more space to store
                items.
                */
                bool add(const apsu::util::felt_t &item);

                /**
                Remove an item from the Cuckoo Filter.
                */
                bool remove(const apsu::util::felt_t &item);
            ...
            private:
                ...
                */
                void get_tag_and_index(
                    const apsu::util::felt_t &item, std::uint32_t &tag, std::size_t &idx) const;
