        ...
        */
        ...
        struct BinBundleCache {
            ...
            */
            ...
            Note that this field is empty when doing unlabeled PSU.
            */
        ...
        represents the label type. This is either a field element (in the case of labeled PSU), or
        an element of the unit type (in the case of unlabeled PSU).
        */
        class BinBundle {
        private:
            /**
            ...
            */
            ...
            /**
            Computes and caches the appropriate polynomials of each bin. For unlabeled PSU, this is
            just the "matching" polynomial. For labeled PSU, this is the "matching" polynomial and
