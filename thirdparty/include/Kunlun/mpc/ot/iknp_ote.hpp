...
inline void RandomSend(NetIO &io, PP &pp, std::vector<block> &vec_K0, std::vector<block> &vec_K1, size_t EXTEND_LEN)
{
    ...
    std::cout << " ====================vec_ inner K================" << std::endl;

    Block::PrintBlocks(vec_inner_K);
                    ...
                    std::vector<uint8_t> &vec_receiver_selection_bit, size_t EXTEND_LEN)
{
    ...
    std::cout << " ====================vec_ inner K0================" << std::endl;

    Block::PrintBlocks(vec_inner_K0);
    std::cout << " ====================vec_ inner K1================" << std::endl;
    Block::PrintBlocks(vec_inner_K1);
...
inline void OnesidedSend(NetIO &io, PP &pp, std::vector<block> &vec_m, size_t EXTEND_LEN) 
{
    ...
    */	
    ...
    RandomSend(io, pp, vec_K0, vec_K1, EXTEND_LEN); 
    std::cout << " ====================vec_K0================" << std::endl;
    Block::PrintBlocks(vec_K0);
    std::cout << " ====================vec_K================" << std::endl;

    Block::PrintBlocks(vec_K1);
    std::cout << " ====================vec_K1================" << std::endl;
...
inline std::vector<block> OnesidedReceive(NetIO &io, PP &pp, std::vector<uint8_t> &vec_receiver_selection_bit, size_t EXTEND_LEN)
{
    ...
    std::cout << " ====================vec_K================" << std::endl;
    for(auto x : vec_receiver_selection_bit)
        printf("%02x\n",x);
    std::vector<block> vec_outer_C(ROW_NUM); 
